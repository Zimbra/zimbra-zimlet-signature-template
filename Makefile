...
download:
	mkdir downloads
	wget -O downloads/zimbra-zimlet-signature-template.zip https://files.zimbra.com/downloads/tmp/zimbra-zimlet-signature-template/zimbra-zimlet-signature-template.zip
